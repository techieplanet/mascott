            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <span>
                                    <a title="Edit" href="#" data-toggle="modal" data-target="#updateHcrModal-<?= $h->id ?>"><i class="fa fa-pencil"></i></a>&nbsp;
                ...
                ?>
                    <!-- Modal -->
                    <div class="modal fade" id="updateHcrModal-<?= $h->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                <h4 class="modal-title" id="myModalLabel">Edit HCR</h4>
                            </div>
                            <div class="modal-body">
                                <?= $form2->field($h, 'name')->textInput(['placeholder'=>'Enter Name']) ?>
                            </div>
