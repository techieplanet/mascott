...
export class AppComponent {
    ...
    saveLayoutBtnOnClick(): void {
        this.savedLayout = this.myLayout.saveLayout();
        this.myLoadLayoutBtn.disabled(false);
    };

    loadLayoutBtnOnClick(): void {
        this.myLayout.loadLayout(this.savedLayout);
        this.myLoadLayoutBtn.disabled(true);
    };
