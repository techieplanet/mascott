...
export class AppComponent implements AfterViewInit {
    ...
    xmlExportClick(): void {
        this.myScheduler.exportData('xml');
    };

    csvExportClick(): void {
        this.myScheduler.exportData('csv');
    };

    tsvExportClick(): void {
        this.myScheduler.exportData('tsv');
    };

    htmlExportClick(): void {
        this.myScheduler.exportData('html');
    };

    jsonExportClick(): void {
        this.myScheduler.exportData('json');
    };

    pdfExportClick(): void {
        this.myScheduler.exportData('pdf');
    };

    icalExportClick(): void {
        this.myScheduler.exportData('ics');
    };
}